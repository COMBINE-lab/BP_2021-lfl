...
#mv the fastq.gz files to a directory called: "samples/human-pbmc1k_v3"
mkdir samples/human-pbmc1k_v3
tar -xvf pbmc_1k_v3_fastqs.tar
mv pbmc_1k_v3_fastqs/*.fastq.gz samples/human-pbmc1k_v3
...
#mv the fastq.gz files to a directory called: "samples/human-pbmc_10k_v3"
mkdir samples/human-pbmc10k_v3
tar -xvf pbmc_10k_v3_fastqs.tar
mv pbmc_10k_v3_fastqs/*.fastq.gz samples/human-pbmc10k_v3
...
#mv the fastq.gz files to a directory called: "samples/mouse-heart1k_v2"
...
#mv the fastq.gz files to a directory called: "samples/mouse-heart1k_v3"
mkdir samples/mouse-heart1k_v3
tar -xvf heart_1k_v3_fastqs.tar
mv heart_1k_v3_fastqs/*.fastq.gz samples/mouse-heart1k_v3
...
#mv the fastq.gz files to a directory called: "samples/mouse-neuron10k_v3"
mkdir samples/mouse-neuron10k_v3
tar -xvf neuron_10k_v3_fastqs.tar
mv neuron_10k_v3_fastqs/*.fastq.gz samples/mouse-neuron10k_v3
...
#mv the fastq.gz files to a directory called: "samples/human_mouse-hgmm1k_v2"
mkdir samples/human_mouse-hgmm1k_v2
tar -xvf hgmm_1k_v2_fastqs.tar
mv hgmm_1k_v2_fastqs/*.fastq.gz samples/human_mouse-hgmm1k_v2
...
#mv the fastq.gz files to a directory called: "samples/human_mouse-hgmm_1k_v3"
mkdir samples/human_mouse-hgmm1k_v3
tar -xvf hgmm_1k_v3_fastqs.tar
mv hgmm_1k_v3_fastqs/*.fastq.gz samples/human_mouse-hgmm1k_v3
...
#mv the fastq.gz files to a directory called: "samples/human_mouse-hgmm_10k_v3"
mkdir samples/human_mouse-hgmm10k_v3
tar -xvf hgmm_10k_v3_fastqs.tar
mv hgmm_10k_v3_fastqs/*.fastq.gz samples/human_mouse-hgmm10k_v3
...
#mv the fastq.gz files to a directory called: "samples/mouse-SRR6998058_v2"
...
#mv the fastq.gz files to a directory called: "samples/rat-SRR7299563_v2"
...
#mv the fastq.gz files to a directory called: "samples/zebrafish-SRR6956073_v2"
...
#mv the fastq.gz files to a directory called: "samples/mouse-SRR8206317_v2"
...
#mv the fastq.gz files to a directory called: "samples/human-SRR8327928_v2"
...
#mv the fastq.gz files to a directory called: "samples/human-SRR8524760_v2"
...
#mv the fastq.gz files to a directory called: "samples/worm-SRR8611943_v2"
...
rename 1.fastq R1.fastq *
rename 2.fastq R2.fastq *
#mv the fastq.gz files to a directory called: "samples/mouse-SRR8639063_v2"
...
rename 1.fastq R1.fastq *
rename 2.fastq R2.fastq *
#mv the fastq.gz files to a directory called: "samples/arabidopsis-SRR8257100_v2"
...
rename 1.fastq R1.fastq *
rename 2.fastq R2.fastq *
#mv the fastq.gz files to a directory called: "samples/mouse-SRR8599150_v2"
...
#mv the fastq.gz files to a directory called: "samples/mouse-EMTAB7320_v2"
